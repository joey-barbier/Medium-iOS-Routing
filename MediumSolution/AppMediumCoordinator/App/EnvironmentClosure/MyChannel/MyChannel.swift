...
extension App {
    struct MyChannel: View {
        ...
        let channelA = Channel(name: "Horka_TV",
                               viewers: [Viewer(name: "HmTici444", isFav: false),
                                         Viewer(name: "ProfesseurWannabe", isFav: false)]
        )
        
        let channelB = Channel(name: "Orka_V2",
                               viewers: [
                                Viewer(name: "iDevDroid", isFav: true),
                                Viewer(name: "Risitas", isFav: true),
                                Viewer(name: "UserNotFav", isFav: false)
                               ])
